...
def RunSimulation(NUMBEROFSIDES,NUMBEROFVERTICALSYSTEMS,NUMBEROFSYSTEMSPERSIDE,FileWrite):
    ...
    mdb.models['Model-1'].BuckleStep(name='Buckle',
                                   numEigen=5, previous='Initial', vectors=50)
    ...
    #                                          mdb.models['Model-1'].rootAssembly.instances['REF-POINT-TOP'].referencePoints[1],
    #                                      )), u1=UNSET, u2=-1, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET)
    mdb.models['Model-1'].ConcentratedForce(cf2=-LOAD, createStepName='Buckle',
        distributionType=UNIFORM, field='', localCsys=None, name='LOAD', region=Region(referencePoints=(
        mdb.models['Model-1'].rootAssembly.instances['REF-POINT-TOP'].referencePoints[1],)))
    ...
    mdb.models['Model-1'].rootAssembly.Set(name='LOAD-SET', vertices=
        mdb.models['Model-1'].rootAssembly.instances['Part-4-1'].vertices.getByBoundingBox(-100*RADIUS,2*spacing*NUMBEROFVERTICALSYSTEMS-TOL,-100*RADIUS,100*RADIUS,2*spacing*NUMBEROFVERTICALSYSTEMS+TOL,100*RADIUS))
    ...
    mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, buckleCase=PERTURBATION_AND_BUCKLING, createStepName='Buckle',
                                         ...
                                         mdb.models['Model-1'].rootAssembly.sets['BOTTOM'],
    ...
    EigenValues = ExtractEigenMode(JobName, 5)
    Values = [NUMBEROFSIDES, NUMBEROFSYSTEMSPERSIDE/2.] + EigenValues
