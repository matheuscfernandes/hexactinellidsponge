...
def RunSimulation(NUMBEROFSIDES,NUMBEROFVERTICALSYSTEMS,NUMBEROFSYSTEMSPERSIDE,FileWrite):
    ...
    # mdb.models['Model-1'].rootAssembly.Set(name='REF-POINT-SET', nodes=
    #     mdb.models['Model-1'].rootAssembly.instances['REF-POINT-TOP'].nodes)
    ...
    UValues = ExtractU('REF-POINT-TOP','Step-1','REF-POINT-TOP',JobName)
